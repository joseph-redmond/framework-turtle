...
public sealed class Array<T> : global::haxe.lang.HxObject, global::Array {
	...
	public int push(T x) {
		unchecked {
			if (( this.length >= ( this.__a as global::System.Array ).Length )) {
				T[] newarr = new T[( (( this.length == 0 )) ? (4) : (( this.length << 1 )) )];
	...
	public void quicksort(int lo, int hi, global::haxe.lang.Function f) {
		unchecked {
			...
			int i = lo;
			int j = hi;
			T p = global::haxe.lang.Runtime.genericCast<T>(buf[( ( lo + hi ) >> 1 )]);
			while (( i <= j )) {
				...
				if (( i <= j )) {
					...
					buf[( i - 1 )] = global::haxe.lang.Runtime.genericCast<T>(buf[j]);
					buf[j--] = t;
				}
	...
	public global::Array<T> filter(global::haxe.lang.Function f) {
		global::Array<T> ret = new global::Array<T>(new T[]{});
		{
			...
			int _g1 = this.length;
			while (( _g < _g1 )) {
				T elt = global::haxe.lang.Runtime.genericCast<T>(this.__a[_g++]);
