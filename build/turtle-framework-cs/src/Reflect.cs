...
public class Reflect : global::haxe.lang.HxObject {
	...
	public static global::Array<string> instanceFields(global::System.Type c) {
		...
		global::System.Reflection.FieldInfo[] mis = ((global::System.Type) (c) ).GetFields(((global::System.Reflection.BindingFlags) (( ( ! (initial2.hasValue) ) ? (default(global::System.Reflection.BindingFlags)) : ((initial2).@value) )) ));
		{
			int _g = 0;
			int _g1 = ( mis as global::System.Array ).Length;
			while (( _g < _g1 )) {
				ret.push(( ((global::System.Reflection.FieldInfo) (mis[_g++]) ) as global::System.Reflection.MemberInfo ).Name);
			}
