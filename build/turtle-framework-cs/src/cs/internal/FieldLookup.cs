...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{4745537, 5442204, 5443986, 5594513, 5742360, 5790305, 57476627, 76061764, 78945784, 87367608, 142301684, 221637784, 302979532, 312752480, 328878574, 343868310, 359333139, 407283053, 437335495, 452737314, 501039929, 520590566, 537630174, 572311959, 630156697, 746281503, 834174833, 863972113, 932127235, 946786476, 1067353468, 1103412149, 1113806382, 1177754921, 1181037546, 1204816148, 1224901875, 1228056441, 1247875546, 1257164128, 1273207865, 1280845662, 1280945120, 1282943179, 1352786672, 1398464674, 1431819701, 1436822557, 1460447810, 1512997393, 1532710347, 1547539107, 1620824029, 1621420777, 1623148745, 1648581351, 1705629508, 1768617329, 1825849507, 1835399246, 1915412854, 1916009602, 1937159360, 1981972957, 2025055113, 2054707467, 2082663554, 2127021138};
		
		protected static string[] fields = new string[]{"__a", "map", "min", "pop", "sin", "tan", "getEnumConstructs", "remove", "__previousException", "filter", "resize", "__nativeException", "methodName", "get_native", "iterator", "dateUTC", "lastIndexOf", "hasNext", "message", "reverse", "insert", "length", "get_message", "native", "array", "contains", "value", "__nativeStack", "random", "toString", "splice", "copy", "date", "__skipStack", "join", "concat", "next", "enumConstructor", "push", "keyValueIterator", "current", "sort", "sqrt", "quicksort", "spliceVoid", "getEnumName", "createEnumIndex", "createEnum", "__ownStack", "posInfos", "concatNative", "className", "__unsafe_get", "__unsafe_set", "indexOf", "fileName", "toDynamic", "allEnums", "unwrap", "round", "__get", "__set", "__hx_deleteField", "lineNumber", "unshift", "enumParameters", "shift", "slice"};
			...
			unchecked {
				...
				bool needsChange = false;
				{
					...
					while (( _g_idx < ( _g_arr as global::System.Array ).Length )) {
						_g_idx += ((uint) (1) );
						if (( global::haxe.lang.FieldLookup.findHash(_g_arr[((int) (((uint) (( _g_idx - 1 )) )) )], cids, clen) < 0 )) {
							needsChange = true;
							break;
						}
